...
> 🤖 **AI-Generated Project**: This application was fully architected and implemented by **Gemini 3 Pro (High)**, an advanced AI model by Google DeepMind, operating within the **Antigravity** agentic coding environment.
